...
namespace NovoBot
{
    ...
    public class NovoBotBot : IBot
    {
        ...
        public async Task OnTurnAsync(ITurnContext turnContext, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                await turnContext.SendActivityAsync("Muito prazer Ulysses. Tudo otimo?");
            }

            else if (responseMessage == "Tudo sim.")
            {
                await turnContext.SendActivityAsync("Muito bom saber.");
            }
